      ...
      <div className="drawer-content flex flex-col">
        ...
        <div className="flex-none hidden lg:block">
          ...
          {userRole === 'manager' && (
            <>
            <li>
              <Link className="btn btn-sm btn-primary m-2" to="/manager" onClick={() => document.getElementById('my-drawer-3').checked = false}>Manager</Link>
            </li>
            </>
          )}
          {userRole === 'staff' && (
            <li>
            <Link className="btn btn-sm btn-primary m-2" to="/staff" onClick={() => document.getElementById('my-drawer-3').checked = false}>Staff</Link>
            </li>
          )}
          {userRole === 'admin' && (
            <>
          ...
          {Auth.loggedIn() ? (
            ...
            <>
            <li>
              <Link className="btn btn-sm btn-primary m-2" to="/login" onClick={() => document.getElementById('my-drawer-3').checked = false}>
              Login
              </Link>
            </li>
            <li>
              <Link className="btn btn-sm btn-primary m-2" to="/signup" onClick={() => document.getElementById('my-drawer-3').checked = false}>
              Signup
              </Link>
            </li>
            </>
